...
<body>
	...
	<form action="" id="rangeform">
		<label for="datepicker">From Date:</label> <input type="text"
			name="fromDate" id="datepicker"> <label for="datepicker">To
			Date:</label> <input type="text" name="toDate" id="datepicker1"> <input
			type="submit" id="daterange" value="Submit"> <br> <br>
		<div>
			<span id="result"></span>
		</div>
		<div>
